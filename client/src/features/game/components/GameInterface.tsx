    ...
    <div className="max-w-2xl mx-auto p-4 space-y-6 animate-in fade-in duration-500">
      ...
      <div className="bg-white p-4 rounded-2xl shadow-lg border border-slate-100 sticky bottom-4">
        <div className="flex gap-2">
          ...
          >
            {feedback === 'success' ? <span className="flex justify-center items-center gap-2"><CheckCircle /> Solved</span> : 
           feedback === 'error' ? <span className="flex justify-center items-center gap-2"><XCircle /> Try Again</span> : "Submit Answer"}
          </button>
        </div>
      </div>
    </div>
